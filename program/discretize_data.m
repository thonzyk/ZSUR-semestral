function [ data_changed ] = discretize_data( data, intervals_per_dimension )
...
data_interval1 = (data_max - data_min) / intervals_per_dimension;
data_interval = [];

for i=1:length(data)
    data_interval = [data_interval; data_interval1];
end
